...
import {
  Check, Send, FileText, Loader, ImagePlus, Trash,
...
import {
  submitReport, ACCEPTED_PHOTO_TYPES, MAX_PHOTO_BYTES,
...
export default function ReportSidebar() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      letter.ask({
        ...
        localizacion: report.localizacion,
  ...
  const modal = (
    <CartaModal
      ...
      intro="Se redactará una carta formal en español a partir de los datos que acabas de enviar. Podrás leerla, editarla y copiarla antes de enviarla tú mismo. Recolle no la envía por ti."
    />
  )
